      ...
      <div className="container">
        ...
        <div className="programs-carousel-container">
          ...
          <div className="level-detail-left">
            ...
            <a href="https://skuare.mindmentorz.com/public/register" target="_blank" rel="noopener noreferrer" className="btn-primary level-enroll-btn">
        ...
        <div className="program-bottom-cta">
          ...
          <a href="https://skuare.mindmentorz.com/public/register" target="_blank" rel="noopener noreferrer" className="btn-primary">
            <span>Enroll Now →</span>
          </a>
        </div>
      </div>
