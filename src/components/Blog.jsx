          ...
          {blog.content.map((block, i) => {
            ...
            if (block.type === 'cta') return (
              <div className="modal-cta-block">
                ...
                <a href="https://skuare.mindmentorz.com/parent-login" target="_blank" rel="noopener noreferrer" className="btn-primary" onClick={onClose}><span>Book a Free Trial →</span></a>
              </div>
            )
            return null
          })}
