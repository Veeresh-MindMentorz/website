    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-partners">
          <h4 className="footer-partners-title">Our Partners</h4>
          <div className="footer-partners-logos">
            <a href="https://www.chess.com" target="_blank" rel="noopener noreferrer" className="partner-logo-link">
              <img src="/chesscom-logo.png" alt="Chess.com" className="partner-logo" />
            </a>
            <a href="https://www.chesskid.com" target="_blank" rel="noopener noreferrer" className="partner-logo-link">
              <img src="/chesskid-logo.png" alt="ChessKid" className="partner-logo" />
            </a>
          </div>
        </div>
        ...
        <div className="footer-grid">
          <div className="footer-brand">
            <Link to="/" className="footer-logo-link">
              <img src={newLogo} alt="Mind Mentorz" className="footer-logo-image" />
            </Link>
          ...
          <div className="footer-links">
            <h4>Program</h4>
            <ul>
              <li><a href="/#program">Level 1 — Absolute Beginner</a></li>
              <li><a href="/#program">Level 2 — Lower Beginner</a></li>
              <li><a href="/#program">Level 3 — Upper Beginner</a></li>
              <li><a href="/#program">Level 4 — Lower Intermediate</a></li>
              <li><a href="/#program">Level 5 — Upper Intermediate</a></li>
              <li><a href="/#program">Level 6 — FIDE Track</a></li>
            </ul>
          </div>
